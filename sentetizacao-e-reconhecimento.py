...
import pyttsx # importamos o modúlo de sintetização
...
en.setProperty('voice', b'brazil') # mudamos a propriedade setando pelo id para pt-br, o segundo argumento:'b' diz que a string está em bytes
en.say('Olá, tudo bem?')
en.runAndWait()
...
s.call(['MPC-HC', 'voz.mp3']) #com o comando call roda nosso comando de voz no player escolhido, no meu caso foi o MPC-HC
